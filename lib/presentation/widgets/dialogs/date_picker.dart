...
import 'cupertino_localization.dart' as loc;
...
void _animateColumnControllerToItem(FixedExtentScrollController controller, int targetItem) {
 ...
 Widget _startSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(capEndEdge: false, capStartEdge: false,  background: Color(0xffEEF4FF).withOpacity(0.1),);
 Widget _centerSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(capStartEdge: false, capEndEdge: false, background: Color(0xffEEF4FF).withOpacity(0.1));
 Widget _endSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(capStartEdge: false,  capEndEdge: false,  background: Color(0xffEEF4FF).withOpacity(0.1));
...
class CupertinoDatePicker extends StatefulWidget {
  ...
  /// mode. When using monthYear mode, both [_.dmy] and
  /// [_.mdy] will result in the month|year order.
  ...
  loc.DefaultCupertinoLocalizations localizations,
...
class _CupertinoDatePickerDateTimeState extends State<CupertinoDatePicker> {
  ...
  late loc.DefaultCupertinoLocalizations localizations;
  ...
  void didChangeDependencies() {
    ...
    localizations = loc.DefaultCupertinoLocalizations();
        ...
        children: List<Widget>.generate(24, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: _isValidHour(selectedAmPm, index)).copyWith(color: hourController.positions.isEmpty ? null : hourController.selectedItem == index ? AppColors.blue : null),
            ),
          );
        }),
      ),
        ...
        children: List<Widget>.generate(60 ~/ widget.minuteInterval, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context, isValid: !isInvalidMinute).copyWith(color: minuteController.positions.isEmpty ? null : minuteController.selectedItem == index ? AppColors.blue : null),
            ),
          );
        }),
      ),
  ...
  void _scrollToDate(DateTime newDate, DateTime fromDate, bool minCheck) {
    SchedulerBinding.instance.addPostFrameCallback((Duration timestamp) {
      ...
      if (fromDate.hour != newDate.hour) {
        final bool needsMeridiemChange = false;
