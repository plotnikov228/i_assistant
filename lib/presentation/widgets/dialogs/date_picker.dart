...
TextStyle _themeTextStyle(BuildContext context, {bool isValid = true}) {
  ...
  return isValid
      ? style.copyWith(
          color: CupertinoDynamicColor.maybeResolve(AppColors.black, context))
      : style.copyWith(
          color: CupertinoDynamicColor.resolve(
              AppColors.black.withOpacity(0.3), context));
}
...
Widget _startSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
  capEndEdge: false,
  capStartEdge: false,
...
Widget _centerSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
    ...
    capEndEdge: false,
    background: Colors.transparent);
Widget _endSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
    capStartEdge: false,
    capEndEdge: false,
    background: Colors.transparent.withOpacity(0.0));
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context,
                  ...
                  .copyWith(
                      color: hourController.positions.isEmpty
                          ? null
                          : hourController.selectedItem == index
                              ? AppColors.blue
                              : null),
            ),
          );
        ...
        children:
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style:
                  _themeTextStyle(context, isValid: !isInvalidMinute).copyWith(
                      color: minuteController.positions.isEmpty
                          ? null
                          : minuteController.selectedItem == index
                              ? AppColors.blue
                              : null),
            ),
          );
