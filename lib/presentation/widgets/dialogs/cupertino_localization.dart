...
abstract class CupertinoLocalizations {
  ...
  // The global version uses the translated string from the arb file.
  c.DatePickerDateOrder get datePickerDateOrder;

  /// The order of the time elements that will be shown in [CupertinoDatePicker].
  // The global version uses the translated string from the arb file.
  c.DatePickerDateTimeOrder get datePickerDateTimeOrder;
...
class DefaultCupertinoLocalizations implements CupertinoLocalizations {
  ...
  @override
  c.DatePickerDateOrder get datePickerDateOrder => c.DatePickerDateOrder.mdy;

  @override
  c.DatePickerDateTimeOrder get datePickerDateTimeOrder => c.DatePickerDateTimeOrder.date_time_dayPeriod;

  @override
  String get anteMeridiemAbbreviation => 'Ч';

  @override
  String get postMeridiemAbbreviation => 'Ч';
