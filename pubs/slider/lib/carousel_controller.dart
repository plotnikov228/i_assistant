...
class CarouselControllerImpl implements CarouselController {
  ...
  @override
  void  addListener (Function() listener) => _state!.pageController!.addListener(listener);



  double get offset => _state!.pageController!.offset;
  ...
  @override
  // TODO: implement page
  double get page => _state!.pageController!.page!;
}
